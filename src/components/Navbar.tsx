        ...
        <div className="flex items-center justify-between h-20">
          ...
          >
            <div className="w-6 h-6 flex flex-col justify-center space-y-1.5">
              <span className={`w-full h-px bg-current transition-all ${isMenuOpen ? 'rotate-45 translate-y-2' : ''}`}></span>
              <span className={`w-full h-px bg-current transition-all ${isMenuOpen ? 'opacity-0' : ''}`}></span>
              <span className={`w-full h-px bg-current transition-all ${isMenuOpen ? '-rotate-45 -translate-y-2' : ''}`}></span>
            </div>
          </button>
        </div>
