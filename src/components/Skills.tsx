...
const Skills = () => {
  return (
    <section id="skills" className="py-12 px-4 bg-gradient-to-br from-blue-50 via-white to-slate-50">
                  ...
                  <div className="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 border border-slate-100 hover:border-blue-200">
                    ...
                    <div className="grid grid-cols-2 gap-1">
                      {category.skills.map((skill, skillIndex) => (
                        <div 
                          key={skillIndex}
                          className="flex items-center gap-1.5 text-slate-600 hover:text-blue-600 transition-colors font-departure text-xs group/skill p-1.5 rounded hover:bg-blue-50"
                        >
